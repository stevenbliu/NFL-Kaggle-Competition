...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        count = 0
        while place_to_check.entrance.name != 'Hive':
            ...
            if count > self.max_range:
                ...
                if len(place_to_check.bees) > 0:
                    bees = place_to_check.bees
                    break
                else:
                    place_to_check = place_to_check.entrance
                count += 1
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            while count < length:
                bee = self.place.bees[count]
                bee.reduce_armor(self.damage)
                if bee.place == None:
                    count -= 1
                    length -= 1
                else:
                    survived_bees.append(bee)
                count += 1
            self.place.bees = survived_bees
            self.place.remove_insect(self)
...
class BodyguardAnt(Ant):
    ...
    def action(self, colony):
        ...
        elif self.place != None and self.place.ant:
...
# END Problem 13
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        self.imposter = False
        if QueenAnt.original == True:
            self.imposter = True
        QueenAnt.original = True
    ...
    def action(self, colony):
        ...
        if self.imposter == True:
            ...
            while place_to_check.exit != None:
                if place_to_check.ant != None:
                    if place_to_check.ant.container and place_to_check.ant.ant != None:
                        if place_to_check.ant.ant not in self.doubled:
                            place_to_check.ant.ant.damage =  place_to_check.ant.ant.damage * 2
                            self.doubled.append(place_to_check.ant.ant)
                    else:
                        if place_to_check.ant not in self.doubled:
                            place_to_check.ant.damage = place_to_check.ant.damage * 2
                            self.doubled.append(place_to_check.ant)
...
def apply_effect(effect, bee, duration):
    ...
    counter = 0
    def action_method(colony, counter = counter):
        if counter < duration:
            counter += 1
            new_action(colony)
        else:
